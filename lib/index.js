    ...
    const dispose = ctx.tools.register({
        ...
        parameters: {
            ...
            properties: {
                ...
                thresholds: {
                    type: 'object',
                    description: 'Optional overrides for audit rule thresholds. Keys are a subset of AuditThresholds ' +
    ...
    if (commands !== undefined) {
        ctx.effect(() => commands.register({
            ...
            handler: async (invocation) => {
                ...
                const format = raw === '' || raw === 'text' ? 'text'
...
async function auditSession(ctx, sessionId, format, thresholds, signal) {
